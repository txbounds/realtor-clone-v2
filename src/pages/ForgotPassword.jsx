...
toast.success("Email was sent - Please check your junk mail folder ")
} catch (error) {
  ...
  return (
    ...
    <img src='https://images.unsplash.com/photo-1584045446619-7146285c9811?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80' alt='logo for key'
